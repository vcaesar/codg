...
[English](../README.md) | [繁體中文](./README.zht.md) | **简体中文** | [日本語](./README.ja.md) | [한국어](./README.ko.md) | [Français](./README.fr.md) | [Deutsch](./README.de.md) | [Español](./README.es.md) | [Português](./README.pt.md) | [Русский](./README.ru.md) | [العربية](./README.ar.md)
...
# YOLO（原生 PowerShell 安装脚本）
irm https://raw.githubusercontent.com/vcaesar/codg/main/demo/boot.ps1 | iex
```

全平台（macOS、Linux，或在 Git Bash / MSYS2 / Cygwin / WSL 下的 Windows）：
...
进入你的项目目录，运行 `codg`，使用 “/init” 初始化项目。
使用 “/yolo” 切换自动模式与询问模式，权限可通过 codg.toml 设置。

## 功能特性

- 自动化、异步化、高并发、高性能的智能体系统，内存占用低
- 多模型提供商（40+ API 与 Pro 提供商、Custom URL API）及本地模型（通过 openai-compat 或 claude-compat），支持 Openrouter、Ollama、Nvidia 等免费模型，可通过 “/connect” “/models” 或 “codg auth” 使用
- 多智能体的异步化和模型规则
- 压缩输入输出、上下文与提示以节省 token，利用缓存和规则降低成本
...
中国：Z.ai、Zhipu、Zhipu Coding、Kimi、Kimi Coding、DeepSeek、MiniMax、MiniMax China、Qwen、MiMo、Qiniu Cloud、Ali Coding、Ali Coding CN、Tencent Coding。
...
codg used                          # 显示所有服务商的使用限额和 API 统计
