...
- دعم نماذج متعددة ونماذج محلية عبر openai-compat أو claude-compat؛ يعمل على أي طرفية ونظام تشغيل
...
تطبيق سطح المكتب (BETA)، ويب (BETA)، Claw (BETA)
...
```bash
# تشغيل واجهة الويب على المنفذ الافتراضي 4096؛ (بعد اكتمال الاختبارات، قم ببنائها).
codg web
# منفذ مخصص.
codg web -p 8080
