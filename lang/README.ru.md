...
- Полная поддержка веб-интерфейса, удалённого TUI и настольного приложения
...
По использованию TUI см. [документацию команд TUI](./docs/cli.ru.md) и введите `/help` в TUI, чтобы посмотреть горячие клавиши и другую справку.
