...
- Поддержка многочисленных провайдеров моделей (API и Pro) и локальных моделей через openai-compat или claude-compat; поддержка бесплатных моделей Openrouter
